view: poc_google_analytics {
  sql_table_name: `POC_GOOGLE_ANALYTICS.POC_GOOGLE_ANALYTICS` ;;
...
view: poc_google_analytics__hits {
  ...
  dimension: poc_google_analytics__hits {
    type: string
    hidden: yes
    sql: poc_google_analytics__hits ;;
  }
  dimension: product {
    hidden: yes
    sql: product ;;
...
view: poc_google_analytics__custom_dimensions {

  dimension: index {
    type: number
    sql: index ;;
  }
  dimension: poc_google_analytics__custom_dimensions {
    type: string
    hidden: yes
    sql: poc_google_analytics__custom_dimensions ;;
  }
  dimension: value {
    type: string
    sql: value ;;
...
view: poc_google_analytics__hits__product {
...
view: poc_google_analytics__hits__promotion {
...
view: poc_google_analytics__hits__custom_metrics {
...
view: poc_google_analytics__hits__custom_variables {
...
view: poc_google_analytics__hits__custom_dimensions {
...
view: poc_google_analytics__hits__experiment {
...
view: poc_google_analytics__hits__publisher_infos {
...
view: poc_google_analytics__hits__product__custom_metrics {
...
view: poc_google_analytics__hits__product__custom_dimensions {
